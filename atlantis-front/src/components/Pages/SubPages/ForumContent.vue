<template>
    <div>
        <div id="title-box">
            ...
            <div v-if="title==='news'">游戏新闻</div>
            <div v-else-if="title==='announces'">游戏公告</div>
            <div v-else-if="title==='basic'">入门</div>
            <div v-else-if="title==='premium'">进阶</div>
            <div v-else-if="title==='online'">联机</div>
            <div v-else-if="title==='rules'">守则</div>
        </div>
        <hr class="hr"/>
        <div id="content-box">
            <!-- pagination -->
